  ...
  return (
    <div className="lg:hidden">
      ...
      <div className="fixed top-6 inset-x-6 sm:inset-x-8 sm:max-w-[360px] z-[90] flex flex-col gap-3.5 select-none pointer-events-none">
        ...
        {/* ── 1. Верхняя стеклянная панель (чистый Tailwind CSS) ─────────── */}
        <div className="pointer-events-auto relative w-full rounded-[20px] bg-gradient-to-r from-[#080e1c]/95 via-[#0c1834]/95 to-[#0e1424]/95 border border-white/[0.12] shadow-[0_25px_60px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.22),0_0_25px_rgba(37,99,235,0.16)] backdrop-blur-3xl p-3 sm:p-3.5 flex items-center justify-between overflow-hidden">
          ...
          {/* Кнопка с кинетической трансформацией (2 длинные линии, без фона и тени) */}
          <button
            type="button"
        ...
        {/* ── 2. Выпадающая панель меню (чистый Tailwind CSS + плавная маска) ── */}
        <div
          style={{
            clipPath: isOpen
        ...
        >
          <div className="relative w-full rounded-[24px] bg-gradient-to-r from-[#080e1c]/95 via-[#0c1834]/95 to-[#0e1424]/95 border border-white/[0.12] shadow-[0_30px_70px_rgba(0,0,0,0.55),inset_0_1px_0_rgba(255,255,255,0.22),0_0_30px_rgba(37,99,235,0.16)] backdrop-blur-3xl p-6 sm:p-7 flex flex-col justify-between overflow-hidden">
            {/* Блик по верхней грани */}
            <div className="pointer-events-none absolute top-0 inset-x-6 h-[1px] bg-gradient-to-r from-transparent via-white/40 to-transparent z-10" />
